#!/usr/bin/env python
"""
Visualization module for gating function comparison results.
Creates clean, presentation-ready plots comparing Baseline vs Multiple Gating Architectures.
...
Usage:
    python dimensionality_increase_visualize.py --results_path results/gating_comparison_results.pkl --output_dir figures
"""
...
# Architecture colors - support baseline + 7 gating functions
ARCH_COLORS = {
    "baseline": "#95a5a6",              # Grey - Baseline
    "exp": "#e74c3c",                   # Red - Exponential (primary)
    "scaled_exp": "#e67e22",            # Orange - Scaled exponential
    "additive": "#f39c12",              # Yellow-orange - Additive
    "softplus": "#2ecc71",              # Green - Softplus
    "tanh": "#3498db",                  # Blue - Tanh
    "sigmoid": "#9b59b6",               # Purple - Sigmoid
    "dot_product": "#1abc9c",           # Teal - Dot product
}

ARCH_LABELS = {
    "baseline": "Baseline (Additive)",
    "exp": "Exponential",
...
def plot_metrics_comparison(results: Dict[str, Any], output_dir: str):
    ...
    for arch in arch_types:
        ...
        extended_metrics[arch] = compute_extended_metrics(targets, preds)
    ...
    plt.suptitle('Gating Function Performance Comparison', fontsize=14, fontweight='bold', y=0.995)
    plt.tight_layout()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Visualize Architecture Comparison Results")
    parser.add_argument("--results_path", type=str, default="results/gating_comparison_results.pkl",
