...
def run_comparison(
	...
	with variant_wandb_run(
		...
		analysis_name="interpolated_latent_v3",
		variant_name="interpolated_latent",
		run_group=run_group,
		tags=["interpolated_latent_v3", "variant_only"],
	):
...
if __name__ == "__main__":
	...
	run_group = make_run_group("interpolated_latent_v3_comparison")
	...
	results_path = save_variant_result(output_dir, "interpolated_latent_v3", "interpolated_latent", results["interpolated_latent"])
