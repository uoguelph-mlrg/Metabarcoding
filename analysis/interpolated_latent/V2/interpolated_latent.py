...
def run_comparison(
	...
	with variant_wandb_run(
		...
		run_group=run_group,
		tags=["interpolated_latent_v2", "variant_only"],
	):
...
if __name__ == "__main__":
	...
	run_group = make_run_group("interpolated_latent_v2_comparison")
	...
	results_path = save_variant_result(output_dir, "interpolated_latent_v2", "interpolated_latent", results["interpolated_latent"])
